...
enum sss_authtok_type {
    ...
    SSS_AUTHTOK_TYPE_FIDO2     =  0x0001, /**< Authentication token is a
                                          * fido2 token, it may or may not
                                          * contain a trailing \\0 */
};
...
enum response_type {
    ...
    SSS_CERT_AUTH_PROMPTING, /**< Indicates that on the server side
                              ...
                              * @param None. */
    SSS_FIDO2_PROMPTING,    /**< Indicates that FIDO2 authentication is available
                             * @param None. */
