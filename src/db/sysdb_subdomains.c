                                    ...
                                    const char *login_shell)
{
    ...
    DEBUG(SSSDBG_TRACE_FUNC, "JS-home_dir: [%s]\n", subdom->template_homedir);
    DEBUG(SSSDBG_TRACE_FUNC, "JS-shell: [%s]\n", subdom->template_shell);
    DEBUG(SSSDBG_TRACE_FUNC, "JS-adding values into memory for : [%s]\n", subdom->name);
