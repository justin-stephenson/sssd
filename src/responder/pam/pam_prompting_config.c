                                             ...
                                             struct prompt_config ***pc_list)
{
    ...
    DEBUG(SSSDBG_TRACE_FUNC, "passkey_inter: [%s]\n", passkey_interactive ? "True" : "False");
    DEBUG(SSSDBG_TRACE_FUNC, "passkey_touch: [%s]\n", passkey_touch ? "True" : "False");
    DEBUG(SSSDBG_TRACE_FUNC, "passkey_inter_prompt: [%s]\n", passkey_interactive_prompt);
    DEBUG(SSSDBG_TRACE_FUNC, "passkey_touch_prompt: [%s]\n", passkey_touch_prompt);
